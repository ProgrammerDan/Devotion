...
public class PlayerPickupItemSource extends Source {
	private static final String insertScript = "INSERT dev_player_pickup_item (trace_id, item_type, item_amount, item_durability, item_enchantments, item_lore, remaining, event_cancelled) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
